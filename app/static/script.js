...
function getNewSubs(live) {
    ...
    fetch(URL+PORT+'/app-tcp/' + endpoint)
    .then(res => res.json())
    .then(data => {
...
setInterval(() => {
    if (liveSubs) {
        fetch(URL+PORT+'/app-tcp/new-subs?type=today')
        .then(res => res.json())
        .then(data => {
...
setInterval(() => {
    if (liveTraj) {
        fetch(URL+PORT+'/app-tcp/trajets?type=today')
        .then(res => res.json())
        .then(data => {
...
setInterval(() => {
    if (liveStation) {
        fetch(URL+PORT+'/app-tcp/stations?type=today&station=' + selectedStation.value)
        .then(res => res.json())
        .then(data => {
